...
export function printRecibo(dados) {
  const { numeroVenda, dataVenda, nomeCliente, formaPagamento, itens = [], valorTotal, desconto, valorFinal } = dados;
...
<head>
  <meta charset="UTF-8">
  <title>Comprovante ${numeroVenda}</title>
  <style>
    ...
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    /* ── Recibo — cresce conforme o conteúdo ───────────────────────── */
    .recibo {
      width: 186mm;
    ...
    .num-venda { font-size: 12px; font-weight: 700; margin-top: 3px; color: #111; }
...
<body>
  <div class="recibo">
    <div class="header">
      ...
      <div class="num-venda">${numeroVenda}</div>
    </div>

    <div class="info">
      <div><span class="label">Data: </span><span class="val">${dataVenda}</span></div>
      <div><span class="label">Pagamento: </span><span class="val">${pgto}</span></div>
  ...
  <div class="corte">- - - - - - - - - - - - - - - RECORTAR AQUI - - - - - - - - - - - - - - -</div>
